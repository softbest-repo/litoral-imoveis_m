<?php
    ...
    // Salva o JSON recebido em um arquivo .txt para registro
    $caminhoArquivo = __DIR__ . '/json_recebido.txt';
    $dataAtual = date('Y-m-d H:i:s');
    $jsonParaSalvar = "[$dataAtual]\n" . $input . "\n\n";
    file_put_contents($caminhoArquivo, $jsonParaSalvar, FILE_APPEND);
