...
?>
            <li><a href="<?php echo $configUrl;?><?php echo $area; ?>/1/" title="Primeira Página">Primeira Página</a></li>
<?php
	}
	if($pagina > 1){
?>            
...
?>
			<li><a href="<?php echo $configUrl;?><?php echo $area; ?>/<?php echo $numPag; ?>/" title="Última Página">Última Página</a></li>
